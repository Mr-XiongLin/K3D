...
from avalanche.models import TrainEvalModel, NCMClassifier,SimpleMLP
from avalanche.training.plugins import EvaluationPlugin
from avalanche.training.plugins.evaluation import default_evaluator
from avalanche.training.losses import ICaRLLossPlugin
from avalanche.training.plugins.strategy_plugin import SupervisedPlugin, LFLPlugin
...
class ICaRL(SupervisedTemplate):
    ...
    def __init__(
        ...
        device=None,
        plugins: Optional[List[SupervisedPlugin,LFLPlugin]] = None,
