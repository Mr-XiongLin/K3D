...
def make_net(num_classes: int, n=5, c=3) -> Net:
    """Create :py:class:`Net` network, the ResNet used in
    ICarl.
    :param num_classes: number of classes, network output size
    :param n: depth of each residual blocks stack
    :param c: number of input channels
    """
    return Net(num_classes, n=n, c=c)
...
def initialize_icarl_net(m: Module):
    ...
    :param m: input network (should be Net).
    """
...
__all__ = ["initialize_net", "make_net", "Net"]
